...
function [PerCell, success] = compute_percell_and_behaviour_for_table(MapsData, ROTATIONS_DEG, CONTEXTS_TO_REFLECT_MAPS, MIN_DIFFERENCE_FOR_MAX_CORRELATION)
    PerCell = [];
    success = true;
    wb = [];
...
%         try
            ...
            perCell = ml_algo_bfo_percell_and_behaviour_general_single(cellData.maps, cellData.contextIds, cellData.digs, ROTATIONS_DEG, MIN_DIFFERENCE_FOR_MAX_CORRELATION);
