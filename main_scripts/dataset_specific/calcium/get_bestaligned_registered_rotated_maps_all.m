...
function [T] = get_bestaligned_registered_rotated_maps_all(BestAligned, MapsData, doNormalization)

    T = [];
    k = 1;
        
    registeredCellNames = unique(BestAligned.registeredCellName);
    for iCell = 1:length(registeredCellNames)
        registeredCellName = registeredCellNames{iCell};
