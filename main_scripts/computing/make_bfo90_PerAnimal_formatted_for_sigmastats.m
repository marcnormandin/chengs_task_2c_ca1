...
function make_bfo90_PerAnimal_formatted_for_sigmastats(analysisSettings, analysisResults)
...
outputFilename = fullfile(analysisSettings.OUTPUT_RESULTS_FOLDER, sprintf('%s_normal_%s_for_sigmastats_%s.xlsx', outputFilenamePrefix, F, dateTag));
