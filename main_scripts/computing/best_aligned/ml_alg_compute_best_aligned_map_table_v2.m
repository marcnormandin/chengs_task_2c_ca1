...
function [F, success] = ml_alg_compute_best_aligned_map_table_v2(T, comparisonMethod, REFLECT_ONE_CONTEXT)
    F = [];
    success = true;
    wb = [];
...
%             end
            ...
            output = ml_alg_best_aligned_average_context_maps_for_cell_v2(cellData.maps, cellData.trialIds, cellData.contextIds, comparisonMethod, REFLECT_ONE_CONTEXT);
