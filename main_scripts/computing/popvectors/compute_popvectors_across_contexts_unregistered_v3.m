...
function [F] = compute_popvectors_across_contexts_unregistered_v3(analysisSettings, BestAligned, BESTALIGNED_STABILITY_THRESHOLD_MIN, BESTALIGNED_STABILITY_THRESHOLD_MAX)
...
BestAlignedWindowed = BestAligned(BestAligned.bestCorrelation > BESTALIGNED_STABILITY_THRESHOLD_MIN & BestAligned.bestCorrelation <= BESTALIGNED_STABILITY_THRESHOLD_MAX,:);
...
% of cells.
[FWindowed] = compute_F(BestAlignedWindowed);
%%
F = FWindowed;
