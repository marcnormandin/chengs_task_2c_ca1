...
function compute_popvectors_within_contexts(analysisSettings, CellRegTable, BestAligned, BESTALIGNED_STABILITY_THRESHOLD_CRITERIA, STABILITY_CLASSIFICATION_GROUP_LABEL)
...
% save the figure
mulana_savefig(hFig, outputFolder, sprintf('calcium_popvectors_within_context_classified_%s',STABILITY_CLASSIFICATION_GROUP_LABEL), {'png', 'svg', 'fig'});

% Save the data
outputFilename = fullfile(outputFolder, sprintf('calciumPopvectorResults_within_context_%s.mat',STABILITY_CLASSIFICATION_GROUP_LABEL) );
